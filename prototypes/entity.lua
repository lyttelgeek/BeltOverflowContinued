    ...
    {
        {
            ...
            icon = "__BeltOverflowContinued__/graphics/indicator.png",
            icon_size = 32,
            -- 2.0: collision_mask now requires a "layers" dictionary table
            ...
            pictures = {
                {
                    filename = "__BeltOverflowContinued__/graphics/indicator.png",
                    width = 32,
                    height = 32
                }
            }
...

        {
            ...
            pictures = {
                {
                    filename = "__BeltOverflowContinued__/graphics/indicator-wide.png",
                    width = 64,
                    height = 32
                }
            }
    ...
    -- "Entity direction can not be set on entity type: decorative" :(
        {
            ...
            pictures = {
                {
                    filename = "__BeltOverflowContinued__/graphics/indicator-tall.png",
                    width = 32,
                    height = 64
                }
            }
